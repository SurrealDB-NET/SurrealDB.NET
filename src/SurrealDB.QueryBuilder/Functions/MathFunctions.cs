...
public static class MathFunctions
{
    ...
    public static TNumber Max<TNumber>(params TNumber[] numbers) where TNumber : INumber<TNumber>
        => throw new IllegalSurrealFunctionCallException();
    ...
    public static TNumber Mean<TNumber>(params TNumber[] numbers) where TNumber : INumber<TNumber>
        => throw new IllegalSurrealFunctionCallException();
    ...
    public static TNumber Median<TNumber>(params TNumber[] numbers) where TNumber : INumber<TNumber>
        => throw new IllegalSurrealFunctionCallException();
    ...
    public static TNumber Min<TNumber>(params TNumber[] numbers) where TNumber : INumber<TNumber>
        => throw new IllegalSurrealFunctionCallException();
    ...
    public static TNumber Product<TNumber>(params TNumber[] numbers) where TNumber : INumber<TNumber>
        => throw new IllegalSurrealFunctionCallException();
    ...
    public static TNumber Sum<TNumber>(params TNumber[] numbers) where TNumber : INumber<TNumber>
        => throw new IllegalSurrealFunctionCallException();
