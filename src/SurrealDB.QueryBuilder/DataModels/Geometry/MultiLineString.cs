...
public class MultiLineString : IGeometry, IEquatable<MultiLineString>
{
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> has the same lines sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> is a <see cref="MultiLineString"/> and has the same lines sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <summary>
    /// Returns the coordinates of this <see cref="MultiLineString"/> as a 3D <see cref="double"/> array. Utilized by <see cref="ToGeoJson"/>.
    /// </summary>
    ...
    /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> have the same lines sequence; otherwise, <see langword="false"/>.</returns>
    ...
    /// <param name="left">A <see cref="MultiLineString"/> to compare.</param>
    /// <param name="right">A <see cref="MultiLineString"/> to compare.</param>
    /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> do not have the same lines sequence; otherwise, <see langword="false"/>.</returns>
    public static bool operator !=(MultiLineString? left, MultiLineString? right)
        => !Equals(left, right);
}
