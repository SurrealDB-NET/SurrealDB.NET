...
public class MultiPoint : IGeometry, IEquatable<MultiPoint>
{
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> is a <see cref="MultiPoint"/> and has the same coordinates sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <summary>
    /// Returns the coordinates of this <see cref="MultiPoint"/> as a 2D <see cref="double"/> array. Utilized in <see cref="ToGeoJson"/>.
    /// </summary>
