...
public class LineString : IGeometry, IEquatable<LineString>
{
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> has the same coordinates sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> is a <see cref="LineString"/> and has the same coordinates sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <summary>
    /// Returns the coordinates of this <see cref="LineString"/> as a 2D <see cref="double"/> array. Utilized by <see cref="ToGeoJson"/>.
    /// </summary>
    ...
    /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> have the same coordinates sequence; otherwise, <see langword="false"/>.</returns>
    ...
    /// <param name="left">A <see cref="LineString"/> to compare.</param>
    /// <param name="right">A <see cref="LineString"/> to compare.</param>
    /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> do not have the same coordinates sequence; otherwise, <see langword="false"/>.</returns>
    public static bool operator !=(LineString? left, LineString? right)
        => !Equals(left, right);
}
