...
public class MultiPolygon : IGeometry, IEquatable<MultiPolygon>
{
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> has the same polygons sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> is a <see cref="MultiPolygon"/> and has the same polygons sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <summary>
    /// Returns the coordinates of this <see cref="MultiPolygon"/> as a 4D <see cref="double"/> array. Utilized by <see cref="ToGeoJson"/>.
    /// </summary>
    ...
    /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> have the same polygons sequence; otherwise, <see langword="false"/>.</returns>
    ...
    /// <param name="left">A <see cref="MultiPolygon"/> to compare.</param>
    /// <param name="right">A <see cref="MultiPolygon"/> to compare.</param>
    /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> do not have the same polygons sequence; otherwise, <see langword="false"/>.</returns>
    public static bool operator !=(MultiPolygon? left, MultiPolygon? right)
        => !Equals(left, right);
}
