...
public class Polygon : IGeometry, IEquatable<Polygon>
{
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> is a <see cref="Polygon"/> and has the same coordinates sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <summary>
    /// Returns the coordinates of this <see cref="Polygon"/> as a 3D <see cref="double"/> array. Utilized by <see cref="ToGeoJson"/>.
    /// </summary>
