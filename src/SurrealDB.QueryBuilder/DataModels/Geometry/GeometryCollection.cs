...
{
    /// <summary>
    /// Gets the collection of <see cref="IGeometry"/>s that define the geometries of this <see cref="GeometryCollection"/>.
    /// </summary>
    /// <value>The collection of <see cref="IGeometry"/>s that define the geometries of this <see cref="GeometryCollection"/>.</value>
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> has the same geometries sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <returns><see langword="true"/> if <paramref name="value"/> is a <see cref="GeometryCollection"/> and has the same geometries sequence as this instance; otherwise, <see langword="false"/>.</returns>
    ...
    /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> have the same geometries sequence; otherwise, <see langword="false"/>.</returns>
    ...
    /// <param name="left">A <see cref="GeometryCollection"/> to compare.</param>
    /// <param name="right">A <see cref="GeometryCollection"/> to compare.</param>
    /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> do not have the same geometries sequence; otherwise, <see langword="false"/>.</returns>
    public static bool operator !=(GeometryCollection? left, GeometryCollection? right)
        => !Equals(left, right);
}
